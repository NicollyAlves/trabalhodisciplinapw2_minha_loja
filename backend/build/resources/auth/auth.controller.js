...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const usuario = yield (0, auth_service_1.checkCredentials)(credentials);
        if (!usuario)
            return res.status(http_status_codes_1.StatusCodes.UNAUTHORIZED).json(http_status_codes_1.ReasonPhrases.UNAUTHORIZED);
